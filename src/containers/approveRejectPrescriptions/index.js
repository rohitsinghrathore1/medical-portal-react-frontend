...
class ApproveRejectPrescriptions extends React.Component {
  ...
  constructor(){
    super();
    this.getApproveRejectPrescriptionsSuccessCb = this.getApproveRejectPrescriptionsSuccessCb.bind(this);
    this.getApproveRejectPrescriptionsFailureCb = this.getApproveRejectPrescriptionsFailureCb.bind(this);
    this.getApproveRejectPrescriptions = this.getApproveRejectPrescriptions.bind(this);
    this.updateAccessStatusSuccessCb = this.updateAccessStatusSuccessCb.bind(this);
    this.updateAccessStatusFailureCb = this.updateAccessStatusFailureCb.bind(this);
  }
                ...
                <TableCell >
                  {
                    data.approval_status === "accessRequested" ? 
                      <Button size="small" color="primary" onClick={()=>this.updateAccessStatus("accessAllowed", data.prescription_id.id )}>Approve</Button>
                    : <Button size="small" color="primary" onClick={()=>this.updateAccessStatus("accessRequested", data.prescription_id.id)}>Reject</Button>
                  }
                </TableCell>
