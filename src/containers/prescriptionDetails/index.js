...
class PrescriptionDetails extends React.Component {
  ...
  constructor(){
    super();
    this.getPrescriptionDetailsSuccessCb = this.getPrescriptionDetailsSuccessCb.bind(this);
    this.getPrescriptionDetailsFailureCb = this.getPrescriptionDetailsFailureCb.bind(this);
    this.requestPrescriptionAccessSuccessCb = this.requestPrescriptionAccessSuccessCb.bind(this);
    this.requestPrescriptionAccessFailureCb = this.requestPrescriptionAccessFailureCb.bind(this);
  }
       ...
       <Table className="records-table">
        ...
        <TableBody>
          ...
          <div>
            ...
            <Button size="small" color="primary" onClick={()=>this.requestPrescriptionAccess()}>Request Prescription Access</Button>
          </div>
        )
    }
